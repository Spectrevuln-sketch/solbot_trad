        ...
        while Attempt:
            ...
            try:
                if quote_response["error"]:
                    ...
                    print(f"e|BUY ERROR {token_symbol} - NOT ENOUGH LIQUIDITY: ",f"{temp}")
                    return "failed"
            except:
                a = 1
        ...
        try:
            ...
            while checkTxn:
                try:
                    ...
                    print(f"e|BUY ERROR {token_symbol}",f"{e}")
                    time.sleep(2)
                    print("Sleeping...")
            ...
            print(f"e|BUY ERROR {token_symbol}",f"{e.args[0].data.logs}")
            time.sleep(1)
            # txnBool = False
            # return "failed"
        except Exception as e:
            print(f"Error: [{e}]...\nEnd...")
            print(f"e|BUY Exception ERROR {token_symbol}",f"{e}")
            txnBool = False
            return "failed"
